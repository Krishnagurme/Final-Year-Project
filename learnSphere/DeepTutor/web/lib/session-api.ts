  ...
  return withClientCache<SessionSummary[]>(
    ...
    async () => {
      try {
        ...
        console.warn('API not available, returning empty sessions list:', error)
        return []
      }
    },
    {
...
export async function getSession(sessionId: string): Promise<SessionDetail | null> {
  try {
    ...
    console.warn('API not available, cannot get session:', error)
    return null
  }
}
...
export async function updateSessionTitle(
  ...
  try {
    ...
    console.warn('API not available, cannot update session title:', error)
    return null
  }
}
...
export async function deleteSession(sessionId: string): Promise<void> {
  try {
    ...
    console.warn('API not available, cannot delete session:', error)
  }
}
...
export async function recordQuizResults(
  ...
  try {
    ...
    console.warn('API not available, cannot record quiz results:', error)
  }
}
